...
use Potoky\EyelensProduct\Model\Product\Type\Eyelens as EyelensProductType;
...
/**
 * Data provider for Eyelens products
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 */
class Eyelens extends AbstractModifier
{
    ...
    protected $uiComponentsConfig = [
        'button_set' => 'eyelens_products_button_set',
        'modal' => 'eyelens_products_modal',
        'listing' => 'eyelens_product_listing',
        'form' => 'product_form',
    ];
    ...
    {
        if ($this->locator->getProduct()->getTypeId() === EyelensProductType::TYPE_CODE) {
            $meta = array_replace_recursive(
                $meta,
                [
                    static::GROUP_EYELENS => [
                        'children' => $this->getChildren(),
                        'arguments' => [
                            'data' => [
                                'config' => [
                                    'label' => __('Eyelens Product'),
                                    'collapsible' => true,
                                    'opened' => true,
